                ...
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            ...
                            <h3 class="mb-1">{{$myWallet ?? 0}}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">My Wallet</h2>
                            <h3 class="fw-extrabold mb-2">{{$myWallet ?? 0}}</h3>
                        </div>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">Company Wallet</h2>
                            <h3 class="mb-1">50.88%</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Company Wallet</h2>
                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                @foreach ($tokenCounts as $token)
                                <tr>
                                    <td>{{ $token->user->name ?? 'Unknown User' }}</td>
                                    <td>{{ $token->total_tokens }}</td>
                                    <td><span class="badge bg-success">{{ $token->active_tokens }}</span></td>
                                    <td><span class="badge bg-danger">{{ $token->deactive_tokens }}</span></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
            ...
            <div class="card border-0 shadow">
                <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
                    <div class="d-block">
                        ...
                        <h2 class="h3 fw-extrabold">Generate Token</h2>
                ...
                <div class="card-body p-2">
                    ...
                    <button type="button" class="btn btn-primary mt-2" onclick="redirectToTokens()">View Tokens</button>
                </div>
            </div>
        </div>
